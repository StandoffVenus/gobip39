...
func (wl english) Words() [WordlistSize]string {
	return wl.words
}
...
func (wl english) FindWord(word string) int {
	index := FindWordIn(wl.words[:], word)
	return index
}

// Singleton of english that is globally visible.
// It holds all the english words, so we do not need to worry about
// users making their own set of english words.
